            ...
            <div class="auth">
                <div class="container">
                    <div class="auth-field">
                        <div class="signin" :class="{ 'font-swell':isSiginSwell === 'signin' }">Login</div>
                        <div class="signup" :class="{'font-swell': isSiginSwell === 'signup'}" @mouseover="handleMouseOver" @mouseout="handleMouseOut">Signup</div>
