  ...
  <div class="main">
    <div class="container a-container" id="a-container">
      <form class="form" id="a-form">
        ...
        <input class="form__input" v-model="model.account" type="text" placeholder="Account" required>
        <input class="form__input" v-model="model.password" type="password" placeholder="Password" required>
        <button class="form__button button submit" type="button" @click="register">SIGN UP</button>
      </form>
    </div>
    ...
    <div class="switch" id="switch-cnt">
      ...
      <div class="switch__container" id="switch-c1">
        ...
        <button class="switch__button button switch-btn" @click="navigateToLogin">SIGN IN</button>
      </div>
...
let register = () => {
  ...
  response.then((res) => {
    ...
    *, *::after, *::before {
    ...
    .form__button:active, .form_button:focus {
